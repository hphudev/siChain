...
import UserViewCustom from '../../views/pages/main/components/User/view'
...
const AppRoutes = [
  ...
  {
    path: '/apps/user/view',
    element: <Navigate to='/apps/user/view/custom/1' />
  },
  {
    element: <UserView />,
  ...
  {
    element: <UserViewCustom />,
    path: 'main/users-management/custom/:id'
  },
  {
    element: <Roles />,
    path: '/apps/roles'
