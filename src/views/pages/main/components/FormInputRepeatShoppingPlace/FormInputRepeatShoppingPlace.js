...
const FormInputRepeatShoppingPlace = () => {
  // ** State
  ...
  return (
    <Card>
      <CardHeader>
        <h4 className='card-title'>Địa điểm mua sản phẩm</h4>
      </CardHeader>
      <CardBody>
        {/* <CardText>
                ...
                <Form>
                  <Row className='justify-content-between align-items-center'>
                    <Col md={10} className='mb-md-0 mb-1'>
                      ...
                      <Input type='text' id={`animation-item-name-${i}`} placeholder='Nhập địa điểm mua hàng' />
                    </Col>
                    ...
                    <Col md={2}>
                      <Button color='danger' className='text-nowrap px-1 mt-2' onClick={deleteForm} outline>
...
export default FormInputRepeatShoppingPlace
