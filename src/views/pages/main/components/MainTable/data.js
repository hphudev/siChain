...
export const serverSideColumns = [
  ...
  },
  {
    ...
    minWidth: '150px',
    selector: row => {
      return new Intl.NumberFormat('vi-VN', { style: 'currency', currency: 'VND' }).format(row.Products.price_in_retail)
    }
  },
  {
    sortable: true,
    ...
    minWidth: '150px',
    selector: row => {
      const date = new Date(row.Products.created_at)
  ...
  },
  {
    ...
    cell: (row) => {
      ...
      return (
        <>
          <ModalShowDetailProduct isShow={isShowDetailModal} changeState={() => setIsShowDetailModal(!isShowDetailModal)} openShowProductHistory={changeShowProductHistory} data={row}/>
          {
            isShowProductHistory && 
              <ModalShowProductHistory isShow={isShowProductHistory} changeState={() => setIsShowProductHistory(!isShowProductHistory)} data={row}/>
          }
          <ModalEditProduct 
            isShow={isShow}
