...
const ModalEditIngredient = (props) => {
      ...
      <Modal isOpen={props.isShow} toggle={() => props.changeState()} className='modal-dialog-centered modal-lg'>
        ...
        <ModalBody className='px-sm-5 mx-50 pb-5'>
          <div className='text-center mb-2'>
            <h1 className='mb-1'>Thay đổi thành phần sản phẩm</h1>
            <p>Thông tin thành phần sản phẩm sẽ bị thay đổi khi được gửi lên.</p>
          </div>
          {/* <Row tag='form' className='gy-1 pt-75' onSubmit={handleSubmit(onSubmit)}>
            ...
            <Col sm='12'>
              <SwiperCoverflowCustom isRtl={isRtl} changeState={props.openImageModal}/>
            </Col>
            <Col xs='12'>
