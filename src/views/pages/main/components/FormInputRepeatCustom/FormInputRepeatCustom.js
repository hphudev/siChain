...
const FormInputRepeatCustom = () => {
  ...
  return (
    <Card>
      <CardHeader>
        <h4 className='card-title'>Thành phần sản phẩm</h4>
      </CardHeader>
      <CardBody>
        {/* <CardText>
                ...
                <Form>
                  <Row className='justify-content-between align-items-center'>
                    <Col md={10} className='mb-md-0 mb-1'>
                      ...
                      <Input type='text' id={`animation-item-name-${i}`} placeholder='Nhập thành phần sản phẩm' />
                    </Col>
...
export default FormInputRepeatCustom
