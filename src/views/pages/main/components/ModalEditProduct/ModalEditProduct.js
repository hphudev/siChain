      ...
      <Modal isOpen={props.isShow} toggle={() => props.changeState()} className='modal-dialog-centered modal-lg'>
        ...
        <ModalBody className='px-sm-5 mx-50 pb-5'>
          <div className='text-center mb-2'>
            <h1 className='mb-1'>Thay đổi thông tin sản phẩm</h1>
            <p>Thông tin sản phẩm sẽ bị thay đổi khi được gửi lên.</p>
          </div>
          <Row tag='form' className='gy-1 pt-75' onSubmit={handleSubmit(onSubmit)}>
            ...
            <Col sm='12'>
              <SwiperCoverflowCustom isShowEditButton={true} isRtl={isRtl} changeState={props.openImageModal} data={props.data.resources}/>
            </Col>
            <Col xs='12'>
              <Label className='form-label'>
                Thành phần
                <span>
                  <Button className='ms-1 btn-sm' color='dark' onClick={props.openIngredientModal}>
                    Chỉnh sửa
                  </Button>
                </span>
              </Label>
            ...
            <Col xs='12'>
              <Label className='form-label'>
                Địa điểm mua hàng
                <span>
                  <Button className='ms-1 btn-sm' color='dark' onClick={props.openShoppingPlaceModal}>
                    Chỉnh sửa
                  </Button>
                </span>
              </Label>
