        ...
        <CardBody>
          <Form onSubmit={handleSubmit(onSubmit)}>
            <Alert color='warning' className='mb-2'>
              <h4 className='alert-heading'>Đảm bảo rằng các yêu cầu này được đáp ứng</h4>
              <div className='alert-body'>Độ dài tối thiểu là 8 ký tự bao gốm ký tự in hoa và đặc biệt</div>
            </Alert>
            <Row>
