    ...
    <Fragment>
      <Card>
        <CardBody>
            ...
            <div className='d-flex align-items-center flex-column'>
              ...
              <div className='d-flex flex-column align-items-center text-center'>
                <div className='user-info'>
                  ...
                  {selectedUser !== null ? (
                    <Badge color={roleColors[selectedUser.Role.key]} className='text-capitalize'>
          ...
          <h4 className='fw-bolder border-bottom pb-50 mb-1'>Chi tiết</h4>
          <div className='info-container'>
            {selectedUser !== null ? (
              <ul className='list-unstyled'>
                <li className='mb-75'>
                  <span className='fw-bolder me-25'>Họ và tên:</span>
                  <span>{selectedUser.name}</span>
                </li>
                {/* <li className='mb-75'>
                  <span className='fw-bolder me-25'>Tên đăng nhập:</span>
                  <span>{selectedUser.name}</span>
                </li> */}
                <li className='mb-75'>
                ...
                {/* <li className='mb-75'>
                  <span className='fw-bolder me-25'>Tình trạng:</span>
                  <Badge className='text-capitalize' color={statusColors[selectedUser.status]}>
                    {selectedUser.status}
                  </Badge>
                </li> */}
                <li className='mb-75'>
                  <span className='fw-bolder me-25'>Vai trò:</span>
                  <span className='text-capitalize'>{selectedUser.Role.key}</span>
                </li>
                {/* <li className='mb-75'>
